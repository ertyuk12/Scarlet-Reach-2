...
/datum/sex_controller/proc/cum_into(oral = FALSE, feedtype = null)
//	var/datum/sex_action/action = SEX_ACTION(current_action)
...
//	var/datum/sex_action/action = SEX_ACTION(current_action)
	...
	if(!can_ejaculate())
		return FALSE
//	if (action.feed_type != null && target != null)
	//	try_succubus_drain()
	return TRUE
...
//these sexcon versions don't seem to work yet, if you're wondering why these are commented
...
//datum/sex_controller/proc/try_succubus_drain(var/us, var/them, var/feedtype)
//	var/datum/sex_action/action = SEX_ACTION(current_action)
...
//datum/sex_controller/proc/try_succubus_charm(var/us, var/them, var/charmtype)
//	var/mob/living/carbon/human/drainer
//	var/datum/sex_action/action = SEX_ACTION(current_action)
//	var/mob/living/carbon/human/drained
//	if (!us)
