...
/datum/customizer/organ/butt/normal
	customizer_choices = list(/datum/customizer_choice/organ/butt/normal)

/datum/customizer_choice/organ/butt/normal
	sprite_accessories = list(/datum/sprite_accessory/butt/pair)
	allows_accessory_color_customization = FALSE


/datum/customizer/organ/butt/anthro
	customizer_choices = list(/datum/customizer_choice/organ/butt/anthro)

/datum/customizer_choice/organ/butt/anthro
	sprite_accessories = list(/datum/sprite_accessory/butt/pair,
							/datum/sprite_accessory/butt/pair/furry)
//	allows_accessory_color_customization = FALSE

/datum/customizer/organ/butt/wildkin
	customizer_choices = list(/datum/customizer_choice/organ/butt/wildkin)

/datum/customizer_choice/organ/butt/wildkin
	sprite_accessories = list(/datum/sprite_accessory/butt/pair,
							/datum/sprite_accessory/butt/pair/furry,
							/datum/sprite_accessory/butt/pair/scaled)
//	allows_accessory_color_customization = FALSE

/datum/customizer/organ/butt/lizard
	customizer_choices = list(/datum/customizer_choice/organ/butt/lizard)

/datum/customizer_choice/organ/butt/lizard
	sprite_accessories = list(/datum/sprite_accessory/butt/pair/scaled)
//llows_accessory_color_customization = FALSE

/datum/customizer/organ/butt/lamia
	customizer_choices = list(/datum/customizer_choice/organ/butt/lamia)

/datum/customizer_choice/organ/butt/lamia
	sprite_accessories = list(/datum/sprite_accessory/butt/pair/lamia)